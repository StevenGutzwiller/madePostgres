...
#define CONFIGURE_ARGS " '--without-readline' 'CFLAGS=-fPIC'"
...
#define PG_VERSION_STR "PostgreSQL 15.5 on x86_64-pc-linux-gnu, compiled by gcc (Debian 12.2.0-14) 12.2.0, 64-bit"
